...
Um Dein Wissen über künstliche Intelligenz zu vertiefen, ist es empfehlenswert, sich mit den verschiedenen Arten von KI auseinanderzusetzen. Das Kapitel *KI Modelle* gibt Dir einen Überblick dafür. Eine weitere hilfreiche Einstiegs-Ressource ist das Kapitel *KI-Tools und Services*, das Dir Einblicke in unterschiedliche Werkzeuge und Dienste, die im Bereich der generativen, künstlichen Intelligenz verfügbar sind, gibt. Dies ist vor allem für die nachfolgenden Aufgaben wichtig und wird später in [Kata 5](https://ai.lernos.org/de/2-06-kata-5/) nochmals aufgegriffen und vertieft.

### Aufgabe: Wähle ein KI-Tool oder probiere mehrere aus
Beim Einstieg in die Welt der KI-Tools stehen Dir verschiedene Optionen offen. Zunächst solltest Du prüfen, welche KI-Plattformen in Deiner Organisation eingesetzt werden dürfen. Wenn es in Deiner Organisation kein empfohlenes KI-Tool gibt, ist oft der [Microsoft Copilot](https://copilot.microsoft.com) oder die kostenlose Version von [ChatGPT](https://chat.openai.com) ein guter Startpunkt. Nennenswert ist auch die KI [Pi](https://pi.ai/talk), denn diese ist unkompliziert ohne vorherige Registrierung nutzbar.
